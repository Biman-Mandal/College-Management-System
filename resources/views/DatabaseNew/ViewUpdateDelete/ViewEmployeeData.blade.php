	   ...
	   @endif
		<div class="ViewDataE ViewData">
			<table>
				...
				@foreach($EmplyeeData as $Data)
				<tr class="Header">
					<td><img src="./StoredImages/{{$Data->EmployeImage}}" alt=""></td>
					<td>{{$Data->EmployeFirstname}}</td>
					<td>{{$Data->EmployeLastname}}</td>
					<td>{{$Data->EmployeDistrict}}</td>
					<td>{{$Data->EmployeMobileNumber}}</td>
					...
					<td>
						...
						<a href="#">Update</a>
						<br>
						<a  href={{"deleteEmployye/".$Data->id}}>Delete</a>
					</td>
